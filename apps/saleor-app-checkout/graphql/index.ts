...
export type OrderUpdatePaymentPublicMetafieldMutationVariables = Exact<{
  orderId: Scalars["ID"];
  data: Scalars["String"];
}>;

export type OrderUpdatePaymentPublicMetafieldMutation = {
  __typename?: "Mutation";
  updateMetadata?: {
    __typename?: "UpdateMetadata";
    errors: Array<{ __typename?: "MetadataError"; code: MetadataErrorCode }>;
...
export const OrderUpdatePaymentPublicMetafieldDocument = gql`
...
export function useOrderUpdatePaymentPublicMetafieldMutation() {
  return Urql.useMutation<
